...
*/
func (a *DefaultAPIService) CatsGet(ctx context.Context) ApiCatsGetRequest {
	return ApiCatsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []Cat
func (a *DefaultAPIService) CatsGetExecute(r ApiCatsGetRequest) ([]Cat, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.CatsGet")
	if err != nil {
...
*/
func (a *DefaultAPIService) CatsIdGet(ctx context.Context, id string) ApiCatsIdGetRequest {
	return ApiCatsIdGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *DefaultAPIService) CatsIdGetExecute(r ApiCatsIdGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.CatsIdGet")
	if err != nil {
...
*/
func (a *DefaultAPIService) CatsIdPut(ctx context.Context, id string) ApiCatsIdPutRequest {
	return ApiCatsIdPutRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *DefaultAPIService) CatsIdPutExecute(r ApiCatsIdPutRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.CatsIdPut")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DefaultAPIService) CatsPost(ctx context.Context) ApiCatsPostRequest {
	return ApiCatsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *DefaultAPIService) CatsPostExecute(r ApiCatsPostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.CatsPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
